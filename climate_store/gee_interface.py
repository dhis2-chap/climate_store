...
from chap_core.time_period import TimePeriod, PeriodRange as _PeriodRange
...
def fetch_era5_data_generator(
    ...
    start = TimePeriod.from_id(period_range.start_period)
    end = TimePeriod.from_id(period_range.end_period)
    period_range = _PeriodRange.from_time_periods(start, end)
    # data = []
...
def fetch_era5_data(
    ...
    return list(fetch_era5_data_generator(polygons, period_range, band_names, reducer=reducer))
